...
export const levels:Level[] = [
  {
    id: 59,
    title: "Match the word bob",
    description: "Find the exact word bob",
    requiredWord:"bob",
    testStrings: [
      { text: "bob", shouldMatch: true },
      { text: "my bobby", shouldMatch: true },
      { text: "he's a bob9", shouldMatch: true },
    ],
    hint: "Just match the exact word bob. Remember it's case sensitive.",
    fullMatch: false,
  },
  {
    id: 101,
